...
app.get('/mithuntechnologies', function(request, response) {
    ...
    response.write("<h2><center>Welcome to  Turali Technologies. Please Contact +91-9492628198 for more information or send an email to thuralanarayanarao@gmail.com <center></h2>" );
    response.end();
